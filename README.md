# Tsketches
The offcial code of Tsketches.

## Setup
```bash
pip install -r requirements.txt
```
The datasets are the top-8 longest time series datasets from www.timeseriesclassification.com.
Users can download the data after z-normlization and tsketches of all datasets from https://drive.google.com/file/d/1u7SRTa0mBDACi9RyYFv-yoT6k3qB62cH/view?usp=sharing.
